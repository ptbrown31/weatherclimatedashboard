...
def _register():
    from . import archive, snapshots, hurricane, scorecard, normals, climate, season, market, reask, headline, traffic, catalogue
    ...
    JOBS["daily"] = chain("scorecard", "normals", "climate", "season", "catalogue", "headline", "traffic")
